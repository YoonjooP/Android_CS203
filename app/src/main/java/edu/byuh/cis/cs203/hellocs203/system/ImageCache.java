...
public class ImageCache {
    ...
    public static void init(Resources res, float w, float h) {
        ...
        airplane_small_left2right = loadAndScale(res, R.drawable.little_airplane, w*0.05f);
        airplane_med_left2right = loadAndScale(res, R.drawable.medium_airplane, w*0.083f);
        airplane_big_left2right = loadAndScale(res, R.drawable.big_airplane, w*0.12f);
        ...
        submarine_small_left2right = loadAndScale(res, R.drawable.little_submarine_f, w*0.05f);
        submarine_med_left2right = loadAndScale(res, R.drawable.medium_submarine_f, w*0.083f);
        submarine_big_left2right = loadAndScale(res, R.drawable.big_submarine_f, w*0.1f);
        submarine_small_right2left = loadAndScale(res, R.drawable.little_submarine, w*0.05f);
        submarine_med_right2left = loadAndScale(res, R.drawable.medium_submarine, w*0.083f);
